...
s.exposeInMainWorld("electronAPI", {
  ...
  // Auto-Update API
  updateGetCurrentVersion: () => n.invoke("update:get-current-version"),
  updateQuitAndInstall: () => n.invoke("update:quit-and-install"),
  onUpdateStatus: (e) => {
    const t = (a, o) => e(o);
    return n.on("update:status", t), () => {
      n.removeListener("update:status", t);
    };
  }
});
